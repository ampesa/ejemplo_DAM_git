...
public class Registro extends JFrame {
	...
	// Botón de ejecución del registro
	...
	public Registro() {
		...
		if(connected) {
			...
			textValidacion.setText("CONECTADOS CON ÉXITO");
			...
			textValidacion.setText("ERROR EN LA CONEXIÓN. Revise su conexión y el acceso a la BBDD");
		}
		...
		btnRegistrar.addActionListener (new ActionListener() {
				public void actionPerformed (ActionEvent arg0) {
					...
					// Si no se cumple ninguna de las condiciones anteriores y los datos son correctos confirmamos al usuario que se ha creado un nuevo Jugador
						...
						// en la BBDD y le confirmamos los datos de creación y registro 
						// Registramos al nuevo usuario y cerramos la conexión con el método nuevoUsuario de la clase Usuarios
						...
						if (Usuarios.isRegistered()){
							...
							// Para este proyecto 8 dejamos abierta la ventana de Registro, mostrando los mensajes de confirmación 
							// o error según corresponda, dejamos como comentario el cierre de la ventana
							// vRegistro.dispose();
						}else{
