...
public class Registro extends JFrame {
	...
	public Registro() {
		...
		btnRegistrar = new JButton("A JUGAR");
		...
		btnRegistrar.addActionListener (new ActionListener() {
				public void actionPerformed (ActionEvent arg0) {
					...
					// Registramos al nuevo usuario y cerramosla conexión con el método nuevoUsuario de la clase Usuario
					udb.nuevoUsuario(textNombre.getText(), textApellido1.getText(), textApellido2.getText(), textNick.getText(), 
