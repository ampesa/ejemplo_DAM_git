 ...
 * ****************************************************
 * 
 * NOTAS DE LA VENTANA JUEGO PARA ESTA VERSIÓN (EXAMEN)
 * 
...
public class VentanaJuego extends JPanel {
		...
		mathDice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if ((Integer)resultado==numerosDados12+1){
					...
					// Actualizamos los puntos en la BBDD
					ConectarDB();
					udb.actualizarJugador(conexion, player);
				}else{
	...
	// Método para recoger el Nombre y los puntos de la ventana Registro a la VentanaJuego y desde VentanaPerfil
